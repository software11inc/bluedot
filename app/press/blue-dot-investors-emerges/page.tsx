...
export const metadata: Metadata = {
  title: "Blue Dot Investors Emerges as a Fintech-Focused Secondaries Investment Firm | Press",
  description:
...
export default function PressEmergencePage() {
  return (
    <>
      ...
      <main className="pt-24 pb-24 bg-white min-h-screen">
        ...
        <section className="py-16 border-b border-[#e5e5e5]">
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <Link
              href="/press"
              className="inline-flex items-center gap-2 text-sm text-[#1C39BB] hover:text-[#0f2178] transition-colors mb-8"
            >
            ...
            <div className="mt-20">
              ...
              >
                <p className="font-mono text-xs tracking-widest text-[#575757]/60 uppercase mb-2">
                  Press Release &middot; April 28, 2026
                </p>
                <h3 className="font-display text-xl md:text-2xl text-[#1C39BB] leading-tight mb-2">
                  Blue Dot Investors and FT Partners Report: Private FinTech
                  Giants Now Outpace Public Peers as Liquidity Cycle Builds
                  Across IPOs, M&amp;A and Secondaries
                </h3>
